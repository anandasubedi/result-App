            ...
            <div class="container">
    			...
    			<div class="collapse navbar-collapse navbar-ex1-collapse">
    				<ul class="nav navbar-nav">
						...
						<li{{ (Request::is('admin/classes') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin') }}}"><span class="glyphicon glyphicon-home"></span> Home</a></li>
						<li{{ (Request::is('admin/classes') ? ' class="active"' : '') }}><a href="{{{ URL::route('results.all') }}}"><span class="glyphicon glyphicon-home"></span> Results</a></li>
						<li{{ (Request::is('admin/students') ? ' class="active"' : '') }}><a href="{{{ URL::route('classes.index') }}}"><span class="glyphicon glyphicon-list-alt"></span> Classes</a></li>
